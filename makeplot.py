...
heat=[[0 for j in range(nsemi)] for k in range(nstar)]

result = subp.run("ls -d data/tideheat*", shell=True, stdout=subp.PIPE).stdout.decode('utf-8')
dirs=result.split()
